...
def main():
    ...
    try:
        ...
        logger.info(f"Forecast generated successfully: {len(forecast_results)} days")
        ...
        forecast_df = pd.DataFrame({
            ...
            'SP500_Predicted': forecast_results,
...
Forecast summary:
- Next day: {forecast_results[0]:.2f}
- 7-day avg: {np.mean(forecast_results[:7]):.2f}
- 30-day avg: {np.mean(forecast_results):.2f}
